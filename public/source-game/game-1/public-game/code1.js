...
gdjs.GameCode.GDNewSprite3Objects5= [];
...
{runtimeScene.getScene().getVariables().getFromIndex(1).add(1);
    ...
    gdjs.GameCode.GDWaveNumberObjects2[i].getBehavior("Text").setText("" + runtimeScene.getScene().getVariables().getFromIndex(1).getAsString());
}
}{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "Wave");
}}
...
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "game over", false);
    ...
    gdjs.GameCode.GDTransitionObjects1[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 1, "Circular", "Forward", 0, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("ScoreLabel"), gdjs.GameCode.GDScoreLabelObjects3);
{for(var i = 0, len = gdjs.GameCode.GDEXP_9595PointObjects3.length ;i < len;++i) {
...
}{for(var i = 0, len = gdjs.GameCode.GDScoreLabelObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDScoreLabelObjects3[i].getBehavior("Text").setText("" + gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(1))));
}
}}
...
{for(var i = 0, len = gdjs.GameCode.GDStatsLabelObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDStatsLabelObjects1[i].getBehavior("Text").setText("Poder: " + runtimeScene.getScene().getVariables().getFromIndex(0).getChild("Power").getAsString() + "\nAlcance: " + runtimeScene.getScene().getVariables().getFromIndex(0).getChild("FireRate").getAsString() + "\nFrecuencia: " + runtimeScene.getScene().getVariables().getFromIndex(0).getChild("Accuracy").getAsString());
}
}}
...
gdjs.GameCode.GDNewSprite3Objects5.length = 0;
