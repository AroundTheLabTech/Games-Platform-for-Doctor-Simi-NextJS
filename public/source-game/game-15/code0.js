...
gdjs.IntroCode.GDsimifrenteObjects1= [];
gdjs.IntroCode.GDsimifrenteObjects2= [];
gdjs.IntroCode.GDsimifrenteObjects3= [];
...
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://totalplaygaming.com.mx/views/dashboard.php", runtimeScene);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11291068);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11292180);
}
}
if (isConditionTrue_0) {
...
gdjs.IntroCode.GDsimifrenteObjects1.length = 0;
gdjs.IntroCode.GDsimifrenteObjects2.length = 0;
gdjs.IntroCode.GDsimifrenteObjects3.length = 0;
