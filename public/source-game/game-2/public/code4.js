...
gdjs.Level2Code.GDGameOverDialogObjects1= [];
gdjs.Level2Code.GDGameOverDialogObjects2= [];
gdjs.Level2Code.GDGameOverDialogObjects3= [];
gdjs.Level2Code.GDGameOverDialogObjects4= [];
...
gdjs.Level2Code.GDScreenOrientationCheckerObjects1= [];
gdjs.Level2Code.GDScreenOrientationCheckerObjects2= [];
gdjs.Level2Code.GDScreenOrientationCheckerObjects3= [];
gdjs.Level2Code.GDScreenOrientationCheckerObjects4= [];
...
gdjs.Level2Code.GDMonster2Objects1= [];
gdjs.Level2Code.GDMonster2Objects2= [];
gdjs.Level2Code.GDMonster2Objects3= [];
gdjs.Level2Code.GDMonster2Objects4= [];
gdjs.Level2Code.GDscorebgObjects1= [];
gdjs.Level2Code.GDscorebgObjects2= [];
gdjs.Level2Code.GDscorebgObjects3= [];
gdjs.Level2Code.GDscorebgObjects4= [];
gdjs.Level2Code.GDmapitaObjects1= [];
gdjs.Level2Code.GDmapitaObjects2= [];
gdjs.Level2Code.GDmapitaObjects3= [];
gdjs.Level2Code.GDmapitaObjects4= [];
gdjs.Level2Code.GDRedButtonWithShadowObjects1= [];
gdjs.Level2Code.GDRedButtonWithShadowObjects2= [];
gdjs.Level2Code.GDRedButtonWithShadowObjects3= [];
gdjs.Level2Code.GDRedButtonWithShadowObjects4= [];
gdjs.Level2Code.GDRENDIRSE2Objects1= [];
gdjs.Level2Code.GDRENDIRSE2Objects2= [];
gdjs.Level2Code.GDRENDIRSE2Objects3= [];
gdjs.Level2Code.GDRENDIRSE2Objects4= [];
...
{
gdjs.copyArray(runtimeScene.getObjects("Joystick"), gdjs.Level2Code.GDJoystickObjects2);
{for(var i = 0, len = gdjs.Level2Code.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDJoystickObjects2[i].hide();
}
}{for(var i = 0, len = gdjs.Level2Code.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDJoystickObjects2[i].ActivateControl(false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
};gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDJoystickObjects2Objects = Hashtable.newFrom({"Joystick": gdjs.Level2Code.GDJoystickObjects2});
...
{gdjs.evtTools.runtimeScene.createObjectsFromExternalLayout(runtimeScene, "Touch controls", 0, 0, 0);
    ...
    gdjs.Level2Code.GDScoreTextObjects2[i].getBehavior("Text").setText(runtimeScene.getGame().getVariables().getFromIndex(1).getAsString());
}
}
{ //Subevents
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__SpriteMultitouchJoystick__HasTouchStartedOnScreenSide.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDJoystickObjects2Objects, "Left", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDJoystickObjects2 */
{for(var i = 0, len = gdjs.Level2Code.GDJoystickObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDJoystickObjects2[i].TeleportAndPress((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22406684);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDJumpButtonObjects2 */
{for(var i = 0, len = gdjs.Level2Code.GDJumpButtonObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDJumpButtonObjects2[i].setColor("74;74;74");
}
}}
...
for (var i = 0, k = 0, l = gdjs.Level2Code.GDJumpButtonObjects1.length;i<l;++i) {
    if ( !(gdjs.Level2Code.GDJumpButtonObjects1[i].getBehavior("MultitouchButton").IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined))) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22407844);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDJumpButtonObjects1 */
{for(var i = 0, len = gdjs.Level2Code.GDJumpButtonObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDJumpButtonObjects1[i].setColor("255;255;255");
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22409332);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22408836);
}
}
if (isConditionTrue_0) {
...
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBottomBoundaryObjects1Objects = Hashtable.newFrom({"BottomBoundary": gdjs.Level2Code.GDBottomBoundaryObjects1});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects1});
...
for (var i = 0, k = 0, l = gdjs.Level2Code.GDPlayerObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDPlayerObjects2[i].getY() > gdjs.evtTools.camera.getCameraBorderBottom(runtimeScene, "", 0) ) {
        isConditionTrue_0 = true;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects1Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDBottomBoundaryObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMonster2Objects1Objects = Hashtable.newFrom({"Monster2": gdjs.Level2Code.GDMonster2Objects1});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMonsterParticlesObjects2Objects = Hashtable.newFrom({"MonsterParticles": gdjs.Level2Code.GDMonsterParticlesObjects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects2});
gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.Level2Code.GDPlayerObjects1});
...
gdjs.Level2Code.GDPlayerObjects2.length = k;
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.Level2Code.GDMonster2Objects1, gdjs.Level2Code.GDMonster2Objects2);

/* Reuse gdjs.Level2Code.GDPlayerObjects2 */
gdjs.Level2Code.GDMonsterParticlesObjects2.length = 0;

{for(var i = 0, len = gdjs.Level2Code.GDMonster2Objects2.length ;i < len;++i) {
    gdjs.Level2Code.GDMonster2Objects2[i].deleteFromScene(runtimeScene);
}
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMonsterParticlesObjects2Objects, (( gdjs.Level2Code.GDMonster2Objects2.length === 0 ) ? 0 :gdjs.Level2Code.GDMonster2Objects2[0].getCenterXInScene()), (( gdjs.Level2Code.GDMonster2Objects2.length === 0 ) ? 0 :gdjs.Level2Code.GDMonster2Objects2[0].getCenterYInScene()), "");
}{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, "PlatformerObject", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{runtimeScene.getGame().getVariables().getFromIndex(1).add(50);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMonster2Objects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMonster2Objects2[i].getBehavior("MonsterEnemy").IsOnFire((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMonster2Objects2[k] = gdjs.Level2Code.GDMonster2Objects2[i];
        ++k;
    }
}
gdjs.Level2Code.GDMonster2Objects2.length = k;
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.Level2Code.GDPlayerObjects1, gdjs.Level2Code.GDPlayerObjects2);
...
/* Reuse gdjs.Level2Code.GDMonster2Objects1 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMonster2Objects1.length;i<l;++i) {
    if ( !(gdjs.Level2Code.GDMonster2Objects1[i].getBehavior("MonsterEnemy").IsOnFire((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined))) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDMonster2Objects1[k] = gdjs.Level2Code.GDMonster2Objects1[i];
        ++k;
    }
}
gdjs.Level2Code.GDMonster2Objects1.length = k;
if (isConditionTrue_0) {
...
}{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Trans2", false);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(22433508);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Monster2"), gdjs.Level2Code.GDMonster2Objects1);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.Level2Code.GDPlayerObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects1Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMonster2Objects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("RENDIRSE2"), gdjs.Level2Code.GDRENDIRSE2Objects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDRENDIRSE2Objects1.length;i<l;++i) {
    if ( gdjs.Level2Code.GDRENDIRSE2Objects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDRENDIRSE2Objects1[k] = gdjs.Level2Code.GDRENDIRSE2Objects1[i];
        ++k;
    }
}
gdjs.Level2Code.GDRENDIRSE2Objects1.length = k;
if (isConditionTrue_0) {
...
gdjs.Level2Code.GDGameOverDialogObjects1.length = 0;
gdjs.Level2Code.GDGameOverDialogObjects2.length = 0;
gdjs.Level2Code.GDGameOverDialogObjects3.length = 0;
gdjs.Level2Code.GDGameOverDialogObjects4.length = 0;
...
gdjs.Level2Code.GDScreenOrientationCheckerObjects1.length = 0;
gdjs.Level2Code.GDScreenOrientationCheckerObjects2.length = 0;
gdjs.Level2Code.GDScreenOrientationCheckerObjects3.length = 0;
gdjs.Level2Code.GDScreenOrientationCheckerObjects4.length = 0;
...
gdjs.Level2Code.GDMonster2Objects1.length = 0;
gdjs.Level2Code.GDMonster2Objects2.length = 0;
gdjs.Level2Code.GDMonster2Objects3.length = 0;
gdjs.Level2Code.GDMonster2Objects4.length = 0;
gdjs.Level2Code.GDscorebgObjects1.length = 0;
gdjs.Level2Code.GDscorebgObjects2.length = 0;
gdjs.Level2Code.GDscorebgObjects3.length = 0;
gdjs.Level2Code.GDscorebgObjects4.length = 0;
gdjs.Level2Code.GDmapitaObjects1.length = 0;
gdjs.Level2Code.GDmapitaObjects2.length = 0;
gdjs.Level2Code.GDmapitaObjects3.length = 0;
gdjs.Level2Code.GDmapitaObjects4.length = 0;
gdjs.Level2Code.GDRedButtonWithShadowObjects1.length = 0;
gdjs.Level2Code.GDRedButtonWithShadowObjects2.length = 0;
gdjs.Level2Code.GDRedButtonWithShadowObjects3.length = 0;
gdjs.Level2Code.GDRedButtonWithShadowObjects4.length = 0;
gdjs.Level2Code.GDRENDIRSE2Objects1.length = 0;
gdjs.Level2Code.GDRENDIRSE2Objects2.length = 0;
gdjs.Level2Code.GDRENDIRSE2Objects3.length = 0;
gdjs.Level2Code.GDRENDIRSE2Objects4.length = 0;
